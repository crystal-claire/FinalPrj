   			  ...
   			  reverseButtons: true
   				...
   				if (result.isConfirmed) {
   					...
   					Swal.fire({
      			    	...
      			    	location.href='ad_faq_delete.lion?code='+code.value;
				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						<div class="collapse" id="homepage" aria-labelledby="headingThree"
							data-bs-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="ad_notice_list.lion">공지사항</a> 
			...
			<main>
				<div class="container-fluid px-4">
					<div class="card mb-4">
						...
						<form method="get" id="adFaqForm" action="ad_faq_delete.lion?code=${faqArticle.code }" >
						<c:forEach var="faqArticle" items="${article }">
						...
						<div class="card-body">
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-6">
										<input type="text" readonly class="form-control-plaintext faq-title-text"
											id="title" value="${faqArticle.title }">
									</div>
								</div>
								<div class="mb-3 row">
							...
							<div class="btn-container notice-btn">
								...
								<button type="button" class="adminBtn saveBtn answerInsertBtn"
									onclick="location.href='ad_faq_updateArticle.lion?code=${faqArticle.code}'">수정</button>
							</div>
							<div>
								<div class="reportDetail-helper"></div>
								<button type="button" class="adminBtn listBtn"
									onclick="location.href='ad_faq_list.lion'">목록</button>
							</div>  
							 <input type="hidden" id="code" name="code" value="${faqArticle.code}">
						</div>
