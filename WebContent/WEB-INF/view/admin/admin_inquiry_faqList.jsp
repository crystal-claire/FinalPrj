				...
				<div class="container-fluid px-4">
					<div class="card mb-4 admin-table-body">
						...
						<div>
							...
							<button type="button" class="btn btn-secondary writeBtn" onclick="location.href='ad_faq_createArticle.lion'">글쓰기</button>
						</div>
						...
						<div class="card-body">
							<table class="table table-bordered table-hover">
								...
								<tbody>
									...
									<c:forEach var="adfaqList" items="${list }">
									<tr>
										<td>${adfaqList.num }</td>
										<td><a href="ad_faq_article.lion?code=${adfaqList.code }">${adfaqList.title }</a></td>
										<td>${adfaqList.id }</td>
										<td>${adfaqList.write_datetime }</td>
									</tr>
									</c:forEach>
