    		...
    		Swal.fire({
    			  ...
    			  if (result.isConfirmed) {
    				  ...
    				  Swal.fire({
      			    	...
      			    	location.href = 'ad_inquiry_update.lion?content=' + answer + '&inquiry_code=' + inquiry_code;
			...
			<main>
				<div class="container-fluid px-4">
					<div class="card mb-4">
						...
						<c:forEach var="inquiryUpdate" items="${article }">
						<div class="card-body">
							<div class="inquiry-container">
									...
									<div class="mb-3 row">
										...
										<div class="col-sm-10">
											<input type="email" readonly class="form-control-plaintext inquiryInsertUpdate-text"
												id="id" value="${inquiryUpdate.writer_id }">
										</div>
									</div>
									<div class="mb-3 row">
										...
										<div class="col-sm-10">
											<input type="text" readonly class="form-control-plaintext inquiryInsertUpdate-text"
												id="title" value="${inquiryUpdate.title }">
										</div>
									</div>
									<div class="mb-3">
										<label class="col-sm-1 col-form-label">질문</label>
										<textarea class="form-control inquiry-textarea" id="content" 
										readonly class="form-control-plaintext" rows="7">${inquiryUpdate.inquiry }</textarea>
									</div>
								</div>
								...
								<div class="admin-textarea-box">
									<form method="post">
										...
										<textarea class="form-control admin-textarea" rows="15" id="answer">${inquiryUpdate.answer }</textarea>
										 
										 
										 <input type="hidden" id="inquiry_code" value="${inquiryUpdate.inquiry_code }">
