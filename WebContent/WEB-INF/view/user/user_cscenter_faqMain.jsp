			...
			<div class="row">
				...
				<div class="col-lg-9 col-md-7">
					<div class="product__discount">
						...
						<c:forEach var="userFaqList" items="${list }">
						<div class="accordion" id="accordionExample">
							<div class="accordion-item">
								<h2 class="accordion-header" id="heading${userFaqList.num }">
									<button class="accordion-button collapsed" type="button"
					
										data-bs-toggle="collapse" data-bs-target="#collapse${userFaqList.num }"
										aria-expanded="false" aria-controls="collapse${userFaqList.num }">
										<i class="fa-solid fa-q"></i>${userFaqList.title }</button>
								</h2>
								<div id="collapse${userFaqList.num }" class="accordion-collapse collapse"
									aria-labelledby="heading${userFaqList.num }" data-bs-parent="#accordionExample">
									<div class="accordion-body">
										<i class="fa-solid fa-a"></i>
										<p class="faq-content">${userFaqList.content }</p>
									</div>
								</div>
							</div>
						</div>
