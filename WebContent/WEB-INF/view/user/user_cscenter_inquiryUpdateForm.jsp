	    			  ...
	    			  if (result.isConfirmed) {
	        			...
	        			// Update 작업 처리 코드 작성하기!
	      			    ...
	      			    Swal.fire({
	      			    	...
	      			    	// 우선 photo_path 빼고 구현
	      			    	location.href='user_cscenter_updateIq.lion?title=' + title + '&content=' + content + '&photo_path=' + photo_path + '&code=' + code;
	      			    });
	      			  }
	    			})
	        });
...
<!-- 								<tr>
								...
								<c:forEach var="userInquiryUpdate" items="${article }">
								<tr>
									<th>제목</th>
									<td><input type="text" class="form-control" id="title" value="${userInquiryUpdate.title }"></td>
								</tr>
								<tr>
									<th>내용</th>
									<td><textarea class="form-control" id="content" rows="15">${userInquiryUpdate.inquiry }</textarea></td>
								</tr>
								<tr>
									<th></th>
									<td>
										<!-- 입력했을 때, 사진이 있었다면..사진도 불러와야 할텐데...
										어떻게 해야되는지 코드부분에서 방법 알아봐서 적용해주세용 -->
										<!-- <input type="file" class="inquiry-file" id="photo_path"/> -->
									</td>
								</tr>
								<%-- <input type="hidden" id="code" value="${userInquiryUpdate.inquiry_code }"> --%>
						...
						<div class="form-btn-box">
							<button type="button" class="btn btn-outline-primary lion-outline-btn listBtn" >목록으로</button>
