			...
			<div class="row">
				...
				<div class="col-lg-9 col-md-7">
					...
					<table class="table noticeTable">
						...
						<tbody>
						<c:forEach var="userNoticeList" items="${list }">
							<tr>
								<th scope="row">${userNoticeList.num }</th>
								<td class="title"><a href="user_cscenter_listNoticeArticle.lion?code=${userNoticeList.code }">${userNoticeList.title }</a></td>
								<td>같이사자</td>
								<td>${userNoticeList.write_day }</td>
							</tr>
						</c:forEach>
							<!-- <tr>
								<th scope="row">10</th>
