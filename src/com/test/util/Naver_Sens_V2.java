...
public class Naver_Sens_V2 
{
	...
	public void send_msg(String tel, String rand) 
	{
		...
		String accessKey = "IjMHo84YSh0DaDeEfpHO";                    	 	// 네이버 클라우드 플랫폼 회원에게 발급되는 개인 인증키
		String secretKey = "lh2yqFb9YwXJbxzNaloEYdAicwPtkVMe6SWuBS6D"; 	 	// 2차 인증을 위해 서비스마다 할당되는 service secret
		String serviceId = "ncp:sms:kr:271102728876:gcsz_sms_test";        		// 프로젝트에 할당된 SMS 서비스 ID
	    ...
	    bodyJson.put("from","01059553540");									// 발신번호 * 사전에 인증/등록된 번호만 사용할 수 있습니다.		
